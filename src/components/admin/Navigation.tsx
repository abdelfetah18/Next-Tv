        ...
        <div className="w-full flex flex-col items-center my-8">
            ...
            <div className="w-11/12 flex flex-col items-center">
                ...
                </div>
                {
                    is_open ? (
                        <div className="w-11/12 flex flex-col items-center">
                            <a href="/admin/create_movie" className={"w-full flex flex-row items-center hover:bg-gray-800 cursor-pointer rounded px-4 py-2 "+(path == "create_movie" ? "bg-gray-800" : "")}>
                                <div className="text-base text-white font-bold mx-2"><FaFilm /></div>
                                <div className="text-base text-white font-bold mx-2">Movie</div>
                            </a>
                            <a href="/admin/create_serie" className={"w-full flex flex-row items-center hover:bg-gray-800 cursor-pointer rounded px-4 py-2 "+(path == "create_serie" ? "bg-gray-800" : "")}>
